...
public class Main extends JFrame implements ActionListener{
	...
	public Main(){
		...
		lblScore.setFont(new Font("¹è´ÞÀÇ¹ÎÁ· µµÇö", Font.BOLD, 30));
		...
		lblVS = new JLabel("VS");
		lblVS.setFont(new Font("¹è´ÞÀÇ¹ÎÁ· µµÇö", Font.BOLD, 30));
		lblVS.setBounds(375, 50, 50, 300);
		
		lblresult = new JLabel();
		lblresult.setFont(new Font("¹è´ÞÀÇ¹ÎÁ· µµÇö", Font.BOLD, 70));
		...
		lblResult = new JLabel();
		lblResult.setFont(new Font("¹è´ÞÀÇ¹ÎÁ· µµÇö", Font.BOLD, 30));
	...
	public void chkResult(int user){
		...
		if(win > 3 && draw < 3 && lose < 3) {
			...
			lblresult.setText(win + "Á¡");
//			lblScore.setText("Æ÷ÀÎÆ® µæÁ¡~!");
		}
		else {
			int lose = get.point;
			lblresult.setText(lose + "Á¡");
		}
		if(draw > 3 && lose >3) {
			lblresult.setText("³¡³µ¾î¿ë");
		}
	}
